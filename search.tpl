<div class="section-title"><h3>Поиск по сайту</h3></div>
...
<div class="row">
<div class="col-6"><button type="button" class="btn-custom btn-block" name="dosearch" id="dosearch" onclick="javascript:list_submit(-1); return false;">Найти</button></div>
<div class="col-6"><button type="button" class="btn-custom btn-block" name="dofullsearch" id="dofullsearch" onclick="javascript:full_submit(1); return false;">Расширенный поиск</button></div>
</div>[/simple-search]
